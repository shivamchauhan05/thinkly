...
// ── Skills learned ────────────────────────────────────────────────────────────
const SKILLS = [
  { icon: Megaphone, title: "Social Media Marketing", desc: "Master Instagram, LinkedIn, and YouTube strategy to grow brand audiences from scratch." },
  { icon: Search, title: "SEO & Content Strategy", desc: "Learn keyword research, on-page optimization, and building content that ranks on Google." },
  { icon: Mail, title: "Email Marketing", desc: "Design campaigns, write copy, and analyze open/click-through rates using real tools like Mailchimp." },
  { icon: BarChart3, title: "Analytics & Reporting", desc: "Track KPIs using Google Analytics, Meta Ads Manager, and build weekly performance dashboards." },
  { icon: Target, title: "Paid Advertising (Meta/Google)", desc: "Set up, run, and optimize real ad campaigns with live budgets under mentor guidance." },
  { icon: ImageIcon, title: "Creative Briefing", desc: "Write briefs for designers, coordinate content calendars, and manage brand voice guidelines." },
];
...
const WEEKS = [
  ...
  { week: "Month 6", title: "Growth Strategy", desc: "Develop a longer-term growth plan and hand off your work with professional documentation.", color: "#94A3B8" },
];
...
const TESTIMONIALS = [
  ...
  { name: "Sneha Kapoor", college: "Symbiosis, Pune", avatar: "SK", color: "#F59E0B", quote: "The regular mentor check-ins were gold. By the third month I was independently running email sequences and shaping real campaigns." },
];
...
export default function MarketingInternshipPage() {
  ...
  return (
    <main style={{ fontFamily: "'Inter', -apple-system, sans-serif", color: "#F1F5F9", paddingTop: 68, position: "relative", background: "#0a1628" }}>
        <style>{`
      ...
      {/* ── HERO ─────────────────────────────────────────────────────────── */}
      <section style={{ padding: "80px 24px 0", overflow: "hidden", position: "relative",}}>
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ opacity: 0, animation: "fadeUp 0.6s ease 0.1s forwards", marginBottom: 24 }}>
            <span style={{ fontSize: 13, color: "#94A3B8" }}>
              ...
              {" / "}
              <a href="/internship" style={{ color: "#94A3B8", textDecoration: "none" }}>Internship</a>
              {" / "}
              <span style={{ color: "#4ADE80" }}>Marketing</span>
            </span>
          </div>
          ...
          <div className="rx-stack" style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 48, alignItems: "flex-end" }}>
            <div>
              ...
              <div style={{ opacity: 0, animation: "fadeUp 0.6s ease 0.2s forwards", marginBottom: 20 }}>
                <span style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(34,197,94,0.08)", border: "1px solid rgba(34,197,94,0.3)", borderRadius: 999, padding: "6px 16px", fontSize: 12, fontWeight: 700, color: "#4ADE80", textTransform: "uppercase", letterSpacing: "0.08em" }}>
              ...
              <h1 style={{ fontSize: "clamp(38px,5vw,64px)", fontWeight: 900, color: "#F8FAFC", lineHeight: 1.05, letterSpacing: "-0.03em", margin: "0 0 8px", opacity: 0, animation: "fadeUp 0.6s ease 0.3s forwards" }}>
                Marketing
              ...
              <p style={{ fontSize: 17, color: "#94A3B8", lineHeight: 1.75, maxWidth: 520, margin: "20px 0 32px", opacity: 0, animation: "fadeUp 0.6s ease 0.45s forwards" }}>
              ...
              <div style={{ display: "flex", gap: 24, flexWrap: "wrap", marginBottom: 36, opacity: 0, animation: "fadeUp 0.6s ease 0.55s forwards" }}>
                {[
                  { icon: Clock, label: "Duration", val: "1–6 Months" },
                  { icon: Laptop, label: "Mode", val: "Remote / Hybrid" },
                  { icon: DollarSign, label: "Stipend", val: "Unpaid" },
                  { icon: ScrollText, label: "Certificate", val: "Verified" },
                ].map((f) => (
                  <div key={f.label} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <f.icon size={18} color="#4ADE80" strokeWidth={1.8} />
                    <div>
                      <div style={{ fontSize: 11, color: "#94A3B8", textTransform: "uppercase", letterSpacing: "0.08em" }}>{f.label}</div>
                      <div style={{ fontSize: 14, fontWeight: 700, color: "#F1F5F9" }}>{f.val}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div style={{ display: "flex", gap: 14, flexWrap: "wrap", opacity: 0, animation: "fadeUp 0.6s ease 0.65s forwards" }}>
                <a href="#"
                  style={{ background: "#22C55E", color: "#08150C", fontWeight: 800, fontSize: 15, padding: "14px 36px", borderRadius: 999, textDecoration: "none", boxShadow: "0 8px 28px rgba(34,197,94,0.28)", transition: "all 0.2s" }}
                ...
                <a href="#curriculum"
                  style={{ border: "1.5px solid rgba(255,255,255,0.16)", color: "#E2E8F0", fontWeight: 600, fontSize: 15, padding: "14px 28px", borderRadius: 999, textDecoration: "none", transition: "all 0.2s" }}
            ...
            <div className="rx-visual" style={{ opacity: 0, animation: "fadeUp 0.6s ease 0.5s forwards", flexShrink: 0 }}>
              <div style={{ width: 280, background: "rgba(255,255,255,0.03)", border: "1.5px solid rgba(255,255,255,0.08)", borderRadius: 24, padding: 28, backdropFilter: "blur(12px)" }}>
                <Megaphone size={40} color="#4ADE80" strokeWidth={1.6} style={{ display: "block", margin: "0 auto 12px" }} />
                <div style={{ textAlign: "center", marginBottom: 20 }}>
                  <div style={{ fontSize: 13, color: "#94A3B8", marginBottom: 4 }}>Students placed in</div>
                  <div style={{ fontSize: 22, fontWeight: 800, color: "#F1F5F9" }}>Marketing Roles</div>
                </div>
                {[
            ...
            <div style={{ display: "flex", gap: 16, animation: "marquee 18s linear infinite", width: "max-content" }}>
              {[...Array(2)].map((_, ri) =>
                ["Google Analytics", "Meta Ads Manager", "Mailchimp", "Canva Pro", "SEMrush", "Hootsuite", "HubSpot", "Notion", "Google Ads", "Buffer"].map((tool) => (
                  <span key={`${ri}-${tool}`} style={{ display: "inline-block", fontFamily: "'JetBrains Mono', ui-monospace, monospace", background: "rgba(34,197,94,0.06)", border: "1px solid rgba(34,197,94,0.3)", borderRadius: 999, padding: "8px 18px", fontSize: 13, color: "#4ADE80", fontWeight: 500, whiteSpace: "nowrap" }}>
                    {tool}
                  </span>
                ))
              )}
      ...
      {/* ── STATS ─────────────────────────────────────────────────────────── */}
      <section style={{ background: "rgba(255,255,255,0.02)", padding: "56px 24px", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 32, textAlign: "center" }} className="rx-2">
          {[
            ...
            <div key={s.label}>
              <div style={{ fontSize: 40, fontWeight: 900, color: "#22C55E", letterSpacing: "-0.02em", fontFamily: "'JetBrains Mono', ui-monospace, monospace" }}>
          ...
          <div className="rx-stack" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
            {SKILLS.map((s, i) => (
              <Reveal key={s.title} delay={i * 70}>
                <div style={{ background: "rgba(255,255,255,0.03)", border: "1.5px solid rgba(255,255,255,0.08)", borderRadius: 18, padding: 26, transition: "all 0.3s", cursor: "default" }}
                  onMouseOver={e => { e.currentTarget.style.borderColor = "rgba(34,197,94,0.5)"; e.currentTarget.style.background = "rgba(34,197,94,0.05)"; e.currentTarget.style.transform = "translateY(-3px)"; }}
                  ...
                  <div style={{ width: 46, height: 46, borderRadius: 12, background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.25)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
                    <s.icon size={21} color="#4ADE80" strokeWidth={1.8} />
                  </div>
                  <h3 style={{ fontSize: 15, fontWeight: 700, color: "#F1F5F9", marginBottom: 8 }}>{s.title}</h3>
                  <p style={{ fontSize: 13.5, color: "#94A3B8", lineHeight: 1.7, margin: 0 }}>{s.desc}</p>
                </div>
              </Reveal>
            ))}
          </div>
              ...
              <Reveal key={w.week} delay={i * 80}>
                <div style={{ display: "flex", gap: 0, alignItems: "stretch" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 48, flexShrink: 0 }}>
                    ...
                    {i < WEEKS.length - 1 && <div style={{ flex: 1, width: 2, background: "rgba(255,255,255,0.1)", marginTop: 6 }} />}
                  </div>
                  {/* Card */}
                  <div style={{ flex: 1, background: "rgba(255,255,255,0.03)", border: "1.5px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: "24px 28px", marginLeft: 16, marginBottom: i < WEEKS.length - 1 ? 16 : 0 }}>
                    ...
                    <h3 style={{ fontSize: 17, fontWeight: 700, color: "#F1F5F9", marginBottom: 8 }}>{w.title}</h3>
                    <p style={{ fontSize: 14, color: "#94A3B8", lineHeight: 1.7, margin: 0 }}>{w.desc}</p>
                  </div>
                </div>
              </Reveal>
            ))}
      ...
      <section style={{ padding: "88px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              <SectionTag>alumni_stories</SectionTag>
            ...
            {TESTIMONIALS.map((t, i) => (
              <Reveal key={t.name} delay={i * 80}>
                <div style={{ background: "rgba(255,255,255,0.03)", border: "1.5px solid rgba(255,255,255,0.08)", borderRadius: 20, padding: 28, transition: "all 0.3s" }}
                  ...
                  <p style={{ fontSize: 14, color: "#CBD5E1", lineHeight: 1.75, fontStyle: "italic", margin: "0 0 24px" }}>"{t.quote}"</p>
      ...
      <section style={{ padding: "88px 24px", background: "rgba(255,255,255,0.02)", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <div style={{ border: "1.5px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.03)", borderRadius: 20, padding: "0 28px" }}>
      ...
      <section style={{ padding: "88px 24px", textAlign: "center", position: "relative", overflow: "hidden", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <div style={{ maxWidth: 600, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <Reveal>
            <Megaphone size={48} color="#4ADE80" strokeWidth={1.6} style={{ display: "block", margin: "0 auto 16px" }} />
            ...
            <p style={{ color: "rgba(226,232,240,0.6)", fontSize: 16, lineHeight: 1.7, marginBottom: 36 }}>
